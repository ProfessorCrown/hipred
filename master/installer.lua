...
print ("Installation HIPRED android version.")
term.setCursor (centrX - 20, 2)
print ("Устанавливается ОС HIPRED андроид версия.")
...
if not _G._OSVERSION or tonumber(_G._OSVERSION:sub(8, 10)) < 1.5 then
	...
	print ("Обнаружена старая версия OpenComputers mod: OS требует, чтобы OpenComputers 1.5 или новее работали правильно !")
end
